                        ...
                        @foreach ($messages as $message)
                            @if ($message['sender_id'] !== auth()->id())
                                ...
                                <div class="grid pb-11">
                                    <div class="flex gap-2.5 mb-4">
                                        <img src="https://pagedone.io/asset/uploads/1710412177.png"
                                            alt="User image" class="w-10 h-11">
                                        <div class="grid">
                            ...
                            @else
                                ...
                                <div class="flex gap-2.5 justify-end pb-4">
                                    ...
                                    <img src="https://pagedone.io/asset/uploads/1704091591.png"
                                        alt="Your image" class="w-10 h-11">
                                </div>
                            @endif
                        @endforeach
